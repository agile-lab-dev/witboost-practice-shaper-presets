...
| Business Ontologies | Business Ontologies provide a formal representation of the business concepts, terminology, and relationships within a company. This landscape allows organizations to define and manage subsets of their corporate business ontology, aligning other systems with well-known business vocabulary and enabling consistent, domain-driven semantics across the platform | [Go to](./src/data-landscapes/business-ontology)             |
| Source Systems      | Source Systems represent the operational applications and systems that expose data assets to the rest of the organization. This landscape models the upstream data producers — such as ERP, CRM, or any transactional system — making their data assets discoverable and consumable within the platform                                 | [Go to](./src/data-landscapes/source-systems)                |
